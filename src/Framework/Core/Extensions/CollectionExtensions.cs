...
namespace MonoRepo.Framework.Core.Extensions
{
    public static class CollectionExtensions
    {
        ...
        public static void AddIfNotNullOrEmpty(this ICollection<KeyValuePair<string, string>> items, string key, string value)
        {
