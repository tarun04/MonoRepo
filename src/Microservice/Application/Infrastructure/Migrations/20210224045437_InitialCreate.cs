        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherPhoneNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MiddleName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    NameSuffix = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AquiredGPA = table.Column<double>(type: "float", nullable: false),
                    CreatedByName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedByName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Degree_DegreeType_DegreeTypeId",
                        column: x => x.DegreeTypeId,
                        principalTable: "DegreeType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Degree_Student_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Degree_DegreeTypeId",
                table: "Degree",
                column: "DegreeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Degree_StudentId",
                table: "Degree",
                column: "StudentId");
